...
class ExtractorGPU(object):
    def __init__(self, blob_vkallocator, staging_vkallocator, net):
        self.blob_vkallocator = blob_vkallocator
        self.staging_vkallocator = staging_vkallocator
        self.net = net
        self.ex = None

    def __enter__(self):
        self.ex = self.net.create_extractor()
        self.ex.set_blob_vkallocator(self.blob_vkallocator)
        self.ex.set_workspace_vkallocator(self.blob_vkallocator)
        self.ex.set_staging_vkallocator(self.staging_vkallocator)
        return self.ex
...
def ncnn_auto_split_process(
    ...
    if max_depth is None or max_depth == current_depth:
        # vkdev = ncnn.get_gpu_device(device_id)
        ...
        try:
            ...
            with ExtractorGPU(blob_vkallocator, staging_vkallocator, net) as ex:
                ...
                # if blob_allocator is not None and staging_allocator is not None:
